...
@implementation MKADTextButtonCellModel
@end

@interface MKADTextButtonCell ()
...
@implementation MKADTextButtonCell

+ (MKADTextButtonCell *)initCellWithTableView:(UITableView *)tableView {
    MKADTextButtonCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKADTextButtonCellIdenty"];
    if (!cell) {
        cell = [[MKADTextButtonCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKADTextButtonCellIdenty"];
    }
    return cell;
}
...
- (void)rightButtonPressed {
    if ([self.delegate respondsToSelector:@selector(ad_textButtonCell_buttonAction:)]) {
        [self.delegate ad_textButtonCell_buttonAction:self.dataModel.index];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKADTextButtonCellModel *)dataModel {
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKADTextButtonCellModel.class]) {
        return;
    }
