...
@interface MKADUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKADDFUModule *dfuModule;
...
@implementation MKADUpdateController

- (void)dealloc {
    NSLog(@"MKADUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ad_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ad_centralDeallocNotification" object:nil];
...
- (MKADDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKADDFUModule alloc] init];
    }
    return _dfuModule;
}
